        ...
        return (
            <div>
                <table className="ui celled table edgy unstackable">
                    ...
                    <tbody>
                        <tr>
                            <td className="online no-right-border">
                                <i className="icon checkmark"></i>在线:</td>
                            <td className="online no-left-border">{this.props.data.link.online}</td>
                            <td className="negative no-right-border">
                                <i className="icon close"></i>离线:</td>
                            <td className="negative no-left-border">{this.props.data.link.offline}</td>
                            <td className="positive no-right-border">恢复:</td>
                            <td className="positive no-left-border">{this.props.data.link.recover}</td>
                            <td className="negative no-right-border">
